...
local OverlordDevelopers = {
	["STEAM_1:0:226903802"] = true, -- Fawful
	["STEAM_0:0:606145877"] = true -- Mike White
}

local OverlordTesters = {
	["STEAM_1:0:226903802"] = true, -- Fawful
	["STEAM_0:0:606145877"] = true -- Mike White
}
...
impulse.Badges = {
	...
	mike = {Material("icon16/star.png"), "Hi, it's me Mike White! The creator of Overlord.", function(ply) return not ply:IsIncognito() and (ply:SteamID() == "STEAM_0:0:606145877") end},
	fawful = {Material("icon16/star.png"), "Hi, it's me Fawful! The creator of Overlord.", function(ply) return not ply:IsIncognito() and (ply:SteamID() == "STEAM_1:0:226903802") end},
	overlorddev = {Material("icon16/cog.png"), "This player is a Developer of the Overlord!", function(ply) return OverlordDevelopers[ply:SteamID()] end},
	...
	overlordtester = {Material("icon16/bug.png"), "This player is tester of overlord.", function(ply) return (OverlordTesters[ply:SteamID()] or false) end},
